\chapter{L'Applicazione}
	...
	dare all'utente, che si sta registrando, la possibilità di sceglersi un
	...
	\section{Lato Server}
		...
		\begin{description}
			\item[Apache CouchDB\texttrademark{}] è un database non relazionale
				implementato sul paradigma Map-Reduce. La comunicazione con esso
				avviene mediante opportuni messaggi HTTP rendendo semplice la
				richiesta di risoluzione di query. Sempre attraverso HTTP è
				possibile inviare e ricevere dati strutturandoli in formato JSON; 
				inoltre è possibile allegare a documenti JSON
				file multimediali di ogni genere. Questo database fornisce
				...
				all'estensione Geocouch anche questa funzionalità è stata resa
				disponibile.
