\chapter{L'Applicazione}
	...
	\section{Lato Client}
		...
		\subsection{Struttura del Progetto}
			...
			analogamente al file \texttt{config.xml} di \pg{} specifica i metadati dell'applicazione e 
			...
			\begin{description}
				...
				\item[controllers, views, styles] contengono rispettivamente file 
							\js{}, XML, e TSS per ogni schermata dell'applicazione. Queste cartelle
							...
							mentre la logica è gestita dal file \js{}.
			\end{description} 
