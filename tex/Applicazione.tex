\chapter{L'Applicazione}
  ...
  ...
    ...
    \section{Lato Client}
        ...
        \label{subsec:structgraphic}
            ...
            differenze sostanziali tra i due frame\-work.\\
            ...
            personalizzati ed assegnare loro particolari comportamenti
        ...
        \subsection{Struttura del Progetto}
            ...
            dovevamo creare un pacchetto .zip da inviare al servizio, ma limitati
            dalla lentezza della rete della nostra abitazione questa operazione
            ...
            comunque evidenziare lo scopo della cartella \texttt{www} e di quella \texttt{merges},
            ...
            \begin{description}
                ...
                \item[lib] qui dentro vanno inseriti i file \js{} che definiscono
            ...
            nella quale inserire i file \js{} per i modelli; tuttavia la documentazione
            di \tisdk{} non è molto chiara su come utilizzarli, per cui
            abbiamo gestito i dati completamente nel controllore.
            
            La cartella \texttt{app} contiene anche il file \texttt{alloy.js}, un particolare file
        ...
        \label{subsec:comlatoserver}
            ...
            sfruttando gli oggetti HTTPClient di \tisdk{} e l'altra basandoci
  ...
  Titanium.App.Properties.removeProperty("name");
            ...
            in \texttt{Properties}; bisogna però notare che questi dati sono caricati in
            ...
            Dal punto di vista dello sviluppo \crossplat{}, \tisdk{} assicura direttamente il funzionamento
            del sistema di memorizzazione descritto, senza dover riadattare il codice
            ...
            Né con \pg{} né con \tisdk{} questo è stato possibile. Nativamente
            ...
            come già detto, dato che l'applicazione è stata sviluppata solo per Android,
            abbiamo ritenuto opportuno prendere nota della differenza, continuando però
            ad usare UUID.
  ...
  app.map = new google.maps.Map(mapElement, mapOptions);
            ...
            \texttt{app/alloy.js} cosicché il caricamento del modulo venga
  ...
  function mapCompleted(evt){ ... }
            ...
            costretti ad utilizzare soltanto il servizio mappe di Google, poiché online
        ...
        \label{subsec:nuova}
            ...
            funzionalità dei widget di cui è composta l'interfaccia grafica.}
            ...
            le informazioni sulle reti WiFi presenti nella zona e la
  ...
  <script>
    ...
    var insertData = function(){
      ...
      customerDataSource.data(dati);
            ...
            Come già detto, costruire una lista con \tisdk{} è simile a \kendomob{}. Dentro
            ...
            degli elementi va ancora definita in XML anziché in \js{}. Nel controllore
            bisogna quindi occuparsi di scaricare i dati dal
            server, di inserirli nella lista e di implementare la funzione
            da eseguire alla pressione sugli elementi. Il tutto però non è così immediato:
            ...
            campi particolari imposti dal framework. Nel frammento \ref{cod:listTiXML} si mostra il
  ...
  var dataClick = function(){
    /* da eseguire al tocco su un elemento della lista */
            ...
            e quindi è necessario dover scrivere codice diverso per ogni piattaforma
            ...
            di bloccare l'interfaccia grafica durante la sua visualizzazione cosicché
            non ci si debba preoccupare delle azioni intraprese dall'utente.
            ...
            venivano scaricate dal server, l'altra invece quando i dati venivano
            ...
            \clearpage
            \noindent In generale, entrambi i frame\-work hanno soddisfatto tutti
        ...
        \label{subsec:dettagli}
            ...
            Realizzare questa funzionalità ha permesso di confrontarci con il
            problema di dover scaricare un file da un server che, in questo caso,
            è l'immagine allegata alla segnalazione da mostrare. CouchDB
            ...
            messaggio MIME che nessun frame\-work forniva. Per questi motivi
    ...
    function newFileSuccess(newf){
      ...
      ft.download(
        ...
        false
            ...
            Anche \tisdk{} consente di accedere al filesys\-tem della piattaforma
            ...
            in \tisdk{} si utilizza l'oggetto \texttt{HTTPClient} definito nelle
            ...
            file si può procedere col richiedere al server l'allegato da
  ...
  httpClt.send();
            \end{lstlisting}
            Una differenza sostanziale che c'è tra \tisdk{} e \pg{} nella
            gestione del filesys\-tem, è che le API del primo consentono di creare
            file persistenti solo in precise directory relative
            all'applicazione stessa per i cui nomi sono definite delle specifiche
        ...
        Questo non siamo però riusciti a farlo con \kendomob{}, non perché
        non fosse possibile, ma perché questa è stata un'aggiunta non richiesta
        ...
        \label{subsec:caching}
            ...
            applicazioni, il nostro tutore aziendale ci ha
            richiesto di aggiungere un meccanismo di caching per
            ...
            possano mostrarle all'utente che potrebbe decidere di
        ...
        \subsection{Dai dettagli alla mappa}
            Come ultimo particolare ci è stato chiesto di aggiungere un
            specifico bottone nella schermata di dettaglio della segnalazione
            ...
            importanti da fare; quello che è più interessante da notare è
            l'aggiunta del bottone nelle barre di intestazione delle schermate
            nei due framework.
            ...
            nelle altre piattaforme; sicuramente non per iOS. Così se si
            ...
            \pg{}, la barra in alto è una navbar \kendomob{}, la stessa per
