\chapter{Framework Valutati}
    ...
    Abbiamo così classificato \tisdk{} come framework per la
    ...
    \section{Framework per Applicazioni Native}
        ...
        \label{sec:titanium}
            \tisdk{} è una piattaforma gratis e open source di sviluppo di
            ...
            linguaggio \js{}. Oltre alle applicazioni mobili questo framework
    ...
    <script>
        ...
        \subsection{PhoneJS}
            ...
            Come \kendomob{}, questo framework è in grado di fornire all'applicazione
            ...
            Ogni widget può essere creato sfuttando jQuery oppure utilizzando
            KnockoutJS.
    ...
    \label{sec:frameworkhybrid}
        ...
        \label{subsec:hybridpg}
            ...
            Questo framework fornisce inoltre un'interfaccia da riga di comando (CLI)
