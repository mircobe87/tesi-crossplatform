\chapter{Framework Valutati}
    ...
    \section{Framework per Applicazioni Native}
        ...
        \label{sec:titanium}
            ...
            \paragraph{API Mobili}
                ...
                utente) o Titanium.Network (per quanto riguarda il net\-work\-ing).
            ...
            \paragraph{Titanium Studio}
                ...
                scrivere, fare test\-ing e de\-bug\-ging delle proprie applicazioni;
                inoltre sono presenti anche vari template e applicazioni di
                ...
                per estendere l'insieme delle API.
    ...
    <body>
      <div data-role="page">
        ...
        <a data-icon="gear" class="ui-btn">Options</a>
            ...
            widget (come bottoni, liste scorrevoli, switch, ecc...) per
            ...
            plug-in e widget personalizzati. Nuovi plug-in permettono di
            estendere le funzionalità del sistema mentre nuovi widget
        ...
        \label{subsec:kendo}
            ...
            frame\-work mobile come layout, view, animazioni di transizione,
            e fornisce un ricco insieme di widget per la costruzione
  ...
  <script>
    $("#btnClickMe").kendoMobileButton();
            ...
            raggruppare questi dati. Molti widget di \kendomob{} supportano
            ...
            Per accelerare ulteriormente il caricamento delle view, se queste
        ...
        \subsection{PhoneJS}
            ...
            lo stile "nativo" appropriato a tutti i widget e a tutti gli elementi
    ...
    \label{sec:frameworkhybrid}
        ...
        \label{subsec:hybridpg}
            ...
            Le API di \pg{} sono consistenti tra le varie piattaforme mobili,
            ...
            {\footnotesize
                \begin{table}
                    ...
                    API disponibili per alcune delle piattaforme supportate.
  ...
  phonegap run "android"
    \end{lstlisting}
            ...
            risultante è un file che può essere distribuito attraverso gli storea
  ...
  <gap:plugin name="org.apache.cordova.camera"/>
    \end{lstlisting}
            ...
            solo il minimo comune denominatore delle API native. In questo modo
  ...
  sencha generate app 'MyApp' './MyApp'
            ...
            \begin{description}
                \item[app/]\hfill \\
                    La cartella contenente i model, le view, i controller e
                    gli store dell'applicazione. Ognuno di questi elementi sono
  ...
  sencha app package build 'packager.json'
            ...
            \begin{figure}[h]
                ...
                \caption{
                    Un applicazione \senchat{} è composta da Model, View,
                    Controller, Store e Profile
                }
            ...
            applicazioni ibride: tra le proprie API sono disponibili numerosi
            widget per creare una consistente interfaccia grafica
