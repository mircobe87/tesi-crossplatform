\chapter{Framework Valutati}
	...
	\section{Framework per Applicazioni Native}
		...
		\label{sec:titanium}
			...
			Titanium è descritto come un framework \crosscomp{}\cite{Web:peptechlearn.blogspot.it} anche se l'uso che si fa di 
			...
			per Android e BlackBerry\cite{Web:KevinPost}.
			...
			partenza\cite{Web:Wiki.cross-compiling}.
			...
			una visione più ad alto livello\cite[Cap.2 - Titanium 
	...
	\end{lstlisting} 
			...
			limitazione~\cite{Web:KevinSite}
