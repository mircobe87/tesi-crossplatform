\chapter{Framework Valutati}
	...
	\label{sec:frameworkwebapp}
		...
		\subsection{KendoUI Mobile}
			...
			completo, infatti KendoUI Mobile offre anche: un solido componente
			DataSource, strumenti di validazione, API per la globalizzazione e
			un framework MVVM (Model View ViewModel). Come jQuery Mobile, KendoUI
			Mobile è basato sulla libreria jQuery.
...
<script>
	$("#btnClickMe").kendoMobileButton();
			...
			DataSource (KendoUI DataSource) è un'astrazione per usare dati
			...
			questi dati. Molti widgets di KendoUI Mobile supportano il data binding,
			...
			dalle API è possibile selezionare un particolare paese in 
