\chapter{Framework Valutati}
	...
	\label{sec:frameworkhybrid}
		...
		\subsection{Sencha Touch}
			...
			Di seguito elenchiamo il principale contenuto della cartella di un
			...
			\begin{description}
				...
				\item[resurces/]\hfill \\
					...
					dall'applicazione.
			\end{description}
			Si parla di models, views e controllers perchè \senchat{} segue
			il modello MVC e stendendolo con altre componenti traendone tutti i
			relativi vantaggi. Quindi un applicazione sarà un insieme di:
			\begin{description}
				\item[Models]\hfill \\
