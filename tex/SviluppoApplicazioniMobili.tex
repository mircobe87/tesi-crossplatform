\chapter{Sviluppo Applicazioni Mobili}
	...
	\label{sec:webapp}
		...
		mobile\cite{White:Native-vs-Html}. Una delle tante novità di HTML5 è la 
		...
		gli store\cite{White:Native-vs-Html}. 
		...
		web app\cite{White:Native-vs-Html}) i vari dispositivi accedono in modo 
